...
;; good format call
;; (format t "~{~20a~^ ~20a~^ ~20a~^ ~20a~^ ~20a~^~%~}" (map 'list #'identity *roles*))
...
(defparameter *roles*
  '#(
    ...
    CRACKER              CRUEL                ABUSER               CYBERNINJA           DEATH
    EATER                DEMAGOGUE            DISSIDENT            DIVER                DOLL-MISTRESS
    ...
    GRADUATE             GRENADONIN           GUNNER               HEALER               HUSSY
    ICE-MAGE             INTEL-SCRIBE         JANITOR              JEDI                 JESTER
    JUSTICE-KEEPER       KNIGHT               KORSAIR              KURWA                LADIESMAN
    LIBRARIAN            LOCKSMITH            LUNATIC              MAHOU-SHOUJO         MASON
    MASTERMIND           MEDIUM               MIDGET               MILL-SWALLOWER       MONK
    MURDERER             MUSICIAN             MYSTIC               NECROMANCER          NINJA
    NOBLEMAN/NOBLEWOMAN  NUCLEAR-PHYSICIST    OCCULT-MASTER        OFFICER              ORDINATOR
    OTAKU                PALADIN              PICKPOCKET           PIRATE               POISON-MAGE
    POKEMON              POLITICIAN           PRACTICANT           PRIEST/PRIESTESS     PROSTITUTE
    PSION                PSYKER               QUARTERBACK          RANGER               RINGSEEKER
    ROCKER               ROGUE                SAGE                 SAIYAN               SAMURAI
    SCIENTIST            SHAPESHIFTER         SLAVE-MASTER         SOCIAL-JUSTICE-WARRIOR SOFTWARE-ENGINEER
...
(defparameter *races*
  '#(
    ...
    QUANTUM-MECHANIC     RACE-THAT-DOESN      'T-EXIST             RACE-X               RANDOMIZER
    REDDITOR             REDGUARD             RETICULAN            RODNEYAN             ROHIRRIM
    ROOMMATE             ROUGELIKE            RUSMOT               SALAMANDER           SATRE
    SCRIPTOR             SCURRIER             SEA                  ELF                  SEGFAULTER
    SENSER               SERB                 SHEEP                SHELL                SHOE
    SINNER               SKELETON             SKILLOR              SNAIL                SNAKEMAN
    SOKOSOLVER           SOVIET               SPAMMER              SPARD                SPECIALIST
    SPIDERMAN            SPIRIT               SPRIGGAN             STAIRSEEKER          STICKER
    SUSTAINER            SUXXOR               SYLPH                TECHLESS             THUNDERLORD
    TONBERRY             TRAINER              TRANSFORMER          TRAPPER              TROLL
    TUMBLRER             TURMENE              TURTLE               UMBER-HULK           UNALIGNMENT-THING
    UNBALANCOR           UNDEFINED            UNGENOMOLD           UNICORN              UNMAGIC
    URIAN                VAMGOYLE             VAMPIRE              VEELA                VENTURE-CAPITALIST
    VIETIS               VIKING               VORTEX               WARPER               WIND-INHABITANT
    WISP                 WOOKIE               WORM-THAT-WALKS      WRAITH               XORN
    YEEK                 YOKUDA               YUGGER               YUKI-ONNA            ZRUTY))
